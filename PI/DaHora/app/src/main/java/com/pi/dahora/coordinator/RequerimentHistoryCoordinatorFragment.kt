...
//    }
    ...
    private fun recycleView() {
        ...
        val onClickListener = ItemClickListener { req ->
            ...
            parentFragmentManager.beginTransaction().addToBackStack("requerimentPending")
                .replace(R.id.fragmentContainerView_Coordinator, fragment).commit()
        }

        val recyclerView = binding.recycleViewCH
    ...
    private fun getData() {
        ...
        val callback = endpoint.getRequirementsByCoordinator(id)
...
//                call: Call<List<Requirement>>,
//                response: Response<List<Requirement>>
//            ) {
//                val requirementsTemp = response.body()
//
//                if (requirementsTemp != null) {
